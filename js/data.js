...
<p>Self-defence is a highly personal journey that will involve different challenges for everyone. Something that may seem easy to one student may be out of reach for another. It is not wholly physical; in fact, the mental aspects of our training are where the most benefit can be found.</p>

<p>It is our goal to remember that failure is CRITICAL to the learning process. Students will fail often and sometimes in spectacular fashion. </p>
...
<div>
	<p>We aim to foster: </p>
		<p>Improved self confidence </p>
		<p>Improved self-respect </p>
		<p>Improved respect for others </p>
		<p>Healthy relationships and communication </p>
		<p>Kindness </p>
		<p>Impulse control and discipline </p>
		<p>Learning skills </p>
		<p>Ability to set boundaries and make decisions </p>
		<p>Etc Etc. </p>
</div>

<p>These skills take years to master, and can sometimes be very large changes. Behavioural change is difficult and will happen slowly over time, with consistent practice.</p>
...
<p>For you as a parent, there are a some things that we ask you to remember:</p>
...
<p>Jiu Jitsu is a superpower, and I intend to use it for good. I am here to train my mind and body, and shape myself into the person I want to be.</p>

<p>In order to reach my potential as a complete warrior, I will always try to follow this code.</p>

	<p>I will show respect to the people I practice with, treat them with kindness and never put them down or criticise them. I will do my best to listen respectfully and focus.</p>

	<p>I will do my best to keep my training partners safe, and to remember that we are here to help each other learn.</p>

	<p>I will try to make sure that I have fun, and that my training partners do too.</p>
 
	<p>I will always try my best and hardest, and do my best not to give up.</p>

	<p>I know that I can only control myself, and I will do my best to keep doing the right thing even if someone else is not. I will never, ever use the things I learn to be a bully, only for safety and protection.</p>

	<p>I will make mistakes, and I will do my best to take responsibility for learning from them. But I promise to treat myself with the same kindness and respect I show to the people around me when I do, and to try to forgive other people when they make mistakes.</p>

	<p>I know that a warrior is disciplined, so I will use these same rules everywhere. At Jiu Jitsu, at school and at home.</p>

<p>If we all do these things together we can train hard, wrestle and have fun, and I will learn how to be a strong and confident grappler, and a strong and confident human. </p>
`,
  coaches: `

<p>For the most part, when parents bring a child to learn self-defence they are hoping for learned respect, improved self-esteem, improved confidence, higher levels of resilience, healthy relationships, boundaries etc. These are really awesome goals that bring a lot of joy to a person’s life in every area and it’s important that we look to foster these outcomes. </p>
...
<div>
	...
	<p>Make everything a game, as much as possible. If we can bring things back from the level of a competition we allow them to experience success and failure, but we can lower the stakes and help the students learn. Games are fun, games encourage experimentation, games reward innovation and make people smile. This should be the goal as much as possible. Gamify the rolling where you can, whatever you can think of.</p>
	
	<p>Try to speak in low, calm tones. This can be very challenging on some days, but students seem to reflect your energy. If you are heightened, they tend to be heightened. Most of the time students will mimic your activity and energy. There are studies showing that a low calm voice causes a listener to become calmer.</p>
	
	<p>Try to Listen and engage with the questions and comments that students make as much as possible, without getting too far down the rabbit hole. This is a great strategy to show the students that you are interested and care about their ideas. It also helps to keep the class in an area that the students want to be. It can be challenging to prevent a class being derailed by endless questions. Sometimes you might want to say “one more question before we move on”, or you might find another way to gently progress the group.</p>
	
	<p>One of my favourite strategies is I try to never to shrug off or ignore a joke or silly question. The kids like to poke fun and have a laugh and might say something offhand, silly or joking in response to the class content. There is usually a grain of truth in whatever they are joking about, and so I try to acknowledge the humour and then address the truth in the comment. Often this allows the group to share a laugh, as well as learn something unexpected or funny.</p>
	
	<p>Remember to encourage the things they do well, and highlight the effective things they are doing. This is regarding behaviour as well as Jiu Jitsu technique. Help them to build habits by showing them what worked in what they are doing so they can try to replicate it. It also helps them see that they are progressing.</p>
	
	<p>Remind students not to compete with each other, to keep each other safe, and encourage them to make it fun for each other. We are a team after all. Even though Jiu Jitsu is an individual sport, it takes a team of people for us to get good at it. Without training partners who challenge us we can’t improve, and our goal should be to help my partner get better so they can push me to get better.</p>
	
	<p>Always be prepared to laugh at your own expense, but never at a student’s expense.</p>
	
	<p>Students are going to feel uncomfortable at times, we aim to help them understand that they are safe. Sometimes we need to verbalise this to students in different ways; don’t be afraid stop two students rolling so that you can highlight something or to make them safe if something is getting out of hand. We need some discomfort to grow, but this needs to be carefully controlled. Too much discomfort can prevent students participating.</p>
	
	<p>Try to get involved in the games and exercises as much as possible. Participating helps to connect you with the students.</p>
	
	<p>Remembering names is hard, but it is very good to practice as much as possible. There are lots of different strategies for this, it might help to find one that works for you.</p>
	
	<p>Don’t put too much pressure on yourself. Classes don’t need to be perfect. Students are looking for pretty much the same things that adults do. Was it fun? Did the coach listen to me and make me feel good? Were the peer interactions friendly? Did I enjoy the games? Did I have some success somewhere? Did someone help me when I needed it? Small moments are very powerful for creating a good impression, it isn’t necessary to have 60 minutes of perfect Jiu Jitsu.</p>
	
	<p>If you have lots of Jiu Jitsu experience you might find it very easy to deliver an hour off the cuff. If not, a lot of the stress can be alleviated by preparing something prior to coaching a class. It doesn’t have to be exhaustive, particularly if you teach or train techniques you are comfortable with. it definitely helps if you have at least some idea of what you want to progress through and the points you are aiming to hit. It might even help to set up a rough idea of how long you want to spend in an area, with some timestamps.</p>
	
	<p>Don’t be afraid to throw your lesson plan in the bin if it isn’t working.</p>
	<p>Don’t be afraid to stick to your lesson plan if it isn’t working.</p>
	
	<p>We can all get tunnel vision when we are concentrating. Try to move around the room to each group or pair or student and give them your full attention while you are there. This can help to get a feel for what students are struggling with, which students are happy or unhappy, which personalities may not work well together. It also means you can give almost every student some personalised input at least once per class which helps with engagement.</p>
	
	<p>Good questions are really good. If they catch your interest, they will probably catch other student’s interest. If a student has a great question it can be a good strategy to stop the class and let everyone see and hear, and maybe practice the response.</p>
	
	<p>There may be times that you need to be stern, but never lose your temper. Students thrive on consistency. We are expecting them to make mistakes, and so to lose our temper when they do is not reasonable. That is not to say that we never show students that we are unhappy, but they need to trust that we still respect them and care. If a student is not able to anticipate our reactions or they are out of proportion it will reduce trust and make us ineffective. Most all of the “rules” I have come across have some exception, but I don’t think this one does.</p>
	
	<p>A group is a really powerful motivator. We have evolved to want to fit in with a group. If we are faced with challenging student behaviour it can be a useful strategy to let the student know that their partner is waiting for them so they can practice, or that the group is trying to listen, or that we all have to wait while they are in the way etc. This can be done gently and without criticism, and can be a powerful invisible force that can help a student to follow the behaviour modelled by the group.</p>
	
	<p>Responsibility is a powerful motivator. Reminding the grey belts that the white belts are watching to see how they act can tighten them up. Asking a student to help a newer student can instil a sense of responsibility that may help modify their behaviour with a positive force.</p>
	
	<p>If someone has done something unsafe, rude or persistently disruptive you may need to have a discussion with them about it. I believe it is always better to find a way to do this as privately as possible. Take them to the side or speak to them after class. Calmly explain what was wrong, why it was an issue and what the correct behaviour is for next time (with reasons). If we give them the information and opportunity most students will be able to correct the behaviour, even if it takes multiple interventions.</p>
	
	<p>With any change, behavioural or technical, try to remember that incremental change is more achievable and sustainable. Some students can process a lot of information, but most kids cannot. Try to address one thing at a time, and give small amounts of information at a time. It doesn’t need to be complicated. You might just teach a certain framing movement and then let students experiment with it in the rolling.</p>
	
	<p>Humour is really good for helping to keep students interested, but be sparing with it. Overuse can result in distracted students.</p>
	
	<p>Try to be consistent with your boundaries. The students will respect it and they will do better if they know what to expect and where the “sides” are. Try not to move the goalposts, and if you do, explain to them why and what happened to cause the change.</p>
	
	<p>In an “active modality” like a Jiu Jitsu class, movement and exercise helps to make the students engaged and receptive to information. Studies have shown these types of classes are great for retention, as long as we pay attention to the timing of our messages during the class.
	The gold standard is to bring the energy (movement) up, then reduce the energy (calm the students down) and deliver important information in the period of lower activity. It is not always easy to do and takes a bit of practice, but it’s good to be aware of. You can ask the students to take a seat, and experienced students will change gears straight away (we are lucky like that). It might be helpful to get students to grab a drink and then return and sit, this can help them to calm their mind before a discussion.</p>
</div>
